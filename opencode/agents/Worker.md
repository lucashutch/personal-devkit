...
## Rules
1. Read supplied code/context; inspect relevant dependencies, callers, tests, and configuration as needed. Make the smallest coherent fix; address the cause, not just the symptom. Report required out-of-scope edits; never expand scope or delegate.

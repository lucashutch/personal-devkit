...
6. If ambiguity, missing dependencies, or failing validation blocks progress, use the `question` tool or return the blocker and what you tried to TechLead.
7. When the phase is complete and validation passes, report back to TechLead so @reviewer can inspect it.

...
3. Commit any unstaged changes (prefer amends for small changes). Read the diff to write a clear, succinct commit messages. Make one or more atomic commits if needed.
